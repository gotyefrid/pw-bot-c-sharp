...
namespace BotCH.MemoryHelpers.Offsets
{
    ...
    */
    public class Comeback146X : OffsetTemplate
    {
        ...
        public override uint PERS_MAX_HP_OFFSET { get => 0x52C; }
        public override uint PERS_TARGETID_OFFSET { get => 0x5B0; }
        public override uint PERS_COOLDOWN_FEED_PET_OFFSET { get => 0xBEC; }
        public override uint PERS_COOLDOWN_POT_HP_OFFSET { get => 0xBB4; }
        public override uint PERS_LOC_X { get => 0x3C; }
        public override uint PERS_LOC_Z { get => 0x40; }
        public override uint PERS_LOC_Y { get => 0x44; }

        public override uint PET_STRUCT_OFFSET { get => 0x1434; }
        ...
        public override uint MOB_DIST_OFFSET { get => 0x28C; }
        public override uint MOB_TARGET_OFFSET { get => 0x208; }
    }
}
